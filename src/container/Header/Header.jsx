...
const Header = () => (
  <div className="app__header app__flex">
      ...
      <div className="app__header-badge">
        <div className="badge-cmp app__flex">
          ...
          <div style={{ marginLeft: 20 }}>
            ...
            <h1 className="name-text">Jean</h1>
          </div>
        </div>
    ...
    <motion.div whileInView={{ opacity: [0, 1] }} transition={{ duration: 0.5, delayChildren: 0.5 }} className="app__header-text">
      <h1 className="head-text over-circle" style={{ color: '#cbcbcb' }}>
